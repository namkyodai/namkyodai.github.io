...
# Load -----------------------------------------------------------------------
raw <- read.csv("../Data/tidy-data/data/tb.csv", na.strings = "")
raw$new_sp <- NULL
...
xtable(raw[1:10, 1:11], file = "../Data/tidy-data/data/tb-raw.tex")
...
xtable(clean[1:15, ], file = "../Data/tidy-data/data/tb-clean-1.tex")
...
xtable(clean[1:15, ], file = "../Data/tidy-data/data/tb-clean-2.tex")
