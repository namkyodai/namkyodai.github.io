...
source("../Data/tidy-data/data/read-fwf.r")
...
raw <- read.fwf2("../Data/tidy-data/data/weather.txt",  cols)
...
xtable(raw[1:10, 1:12], file = "../Data/tidy-data/data/weather-raw.tex", digits = 1)
...
xtable(clean1[1:10, ], file = "../Data/tidy-data/data/weather-clean-1.tex", digits = 1)

# Cast

clean2 <- dcast(clean1, ... ~ element)
xtable(clean2[1:10, ], file = "../Data/tidy-data/data/weather-clean-2.tex", digits = 1)
